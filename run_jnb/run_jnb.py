...
def main():
    ...
    parser.add_argument('-a', "--arg", help="jupyter notebook argument as json file or as json string (python3 only)",
                        default=None, type=str)
    parser.add_argument("-v", "--verbose", help="write the output as csv. -v for the path of the generated notebook and th error prompt number. -vv appends also the error type and value and for more it appends the error traceback.", action='count')

...
if __name__ == '__main__':
    ...
    parser.add_argument("-e","--execution_path", help="The path of the folder where to execute the notebook.  r'///input' or r'///output' can be used to denote the input / output folder.",

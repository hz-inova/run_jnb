...
def main():
    ...
    parser.add_argument("-m", "--return_mode", help="flag to write the generated notebook to the output_path. Except to write just in case of an error and true /false to write it always /never.",
